...
function simulated_annealing(dist, dim::Int32;
    ...
    return initial_sol, best_sol, iter, accepted_moves, elapsed_time, history
end
...
function main()
    ...
    initial_sol, best_sol, iters, accepted_moves, elapsed_time, history =
        simulated_annealing(dist, dim; time_limit = 10.0)
